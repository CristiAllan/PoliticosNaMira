class PoliticiansController < ApplicationController
  before_action :polotician, :only[:show, :edit, :update, :destroy]
  ...
  private
    ...
    def politician_params
      params.require(:politician).permit(:name, :political_party, :age, :type, :state, :image_url)
    end
end
